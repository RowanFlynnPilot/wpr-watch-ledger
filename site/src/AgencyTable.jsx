...
const CSV_COLS = [
  ...
  { label: "Portal read by hand", get: (a) => (a.portal ? (a.portal.hand_read ? "yes" : "no") : null) },
  ...
  { label: "Other technology (EFF Atlas)", get: (a) => a.other_tech?.map((t) => t.technology).join("; ") || null },
...
const COLUMNS = [
  ...
  { key: "cameras", label: "Cameras", title: "Total cameras the agency reports on its transparency portal (plate readers plus any other Flock cameras)", get: (a) => a.portal?.cameras ?? -1, numeric: true },
